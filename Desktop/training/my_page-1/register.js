...
{
  var usercheck=userValidation();
  console.log(usercheck);
  if(usercheck===0)
  {
    alert("This user field already exist...");
    return false;
  }
  let uid= document.registration.username.value;
...
localStorage.setItem("imgData", imgData);
  ...
  {
    if(user_check(uid,5,12,'Username'))
    {
...
function userValidation()
{
  ...
  var check=localStorage.getItem(uid);
...
function user_check(uid,mx,my,a)
{
